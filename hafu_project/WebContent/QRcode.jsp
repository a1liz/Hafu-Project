...
function time()
{
  ...
  document.getElementById("info1").innerHTML="订单生成时间："+hours+":"+minutes;
  document.getElementById("info2").innerHTML="预计送达时间："+arrivehours+":"+arriveminutes;
  }
</script>
<!-- //js -->	
<!-- cart -->
			...
			<div class="register">
				<form> 
					<div class="register-top-grid">
						<h3>请扫描下方二维码完成支付</h3>
						<div class="input">
							<span><font size="4"></font><label>*</label></span>
						<!-- 	<a href="QRcode.jsp"> -->
							<img src="images/right1.png" style="width:200px;height:200px;position:absolute;left:350px;top:300px;"></img>
							</a>
							<img src="images/gezi11.jpg" style="width:200px;height:200px;position:absolute;left:650px;top:300px;"></img>
							</a>
							<!-- <input type="text">  -->
						</div>
