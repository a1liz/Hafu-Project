			...
			<div class="register">
				<form> 
					<div class="register-top-grid">
						<h3>请支付</h3>
						<div class="input">
							<span><font size="4">饿死了么提供下列两种支付方式</font><label>*</label></span>
							<a href="QRcode.jsp">
							<img src="images/gezi2.jpg" style="width:200px;height:200px;position:absolute;left:500px;top:300px;"></img>
							</a>
							<a href="QRcode.jsp">
                            <img alt="支付宝" src="images/gezi3.jpg" 
                             style="width:200px;height:200px; position:absolute;left:800px;top:300px;"></a><!-- <input type="text">  -->
						</div>
