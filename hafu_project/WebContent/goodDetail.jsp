...
<html>
<head>
<title>${requestScope.hafuGoodComment.goodname}</title>
<!-- Custom Theme files -->
		...
		<div class="container">
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					...
					<h1 class="navbar-brand"><a  href="good_search?sid=1">Dicos</a></h1>
				</div>
				<!--navbar-header-->
			...
			<div class="single-grids">				
				<div class="col-md-4 single-grid">		
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/left.jpg">
								<div class="thumb-image"> <img src="images/left.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="${requestScope.hafuGoodComment.icon}">
								 <div class="thumb-image"> <img src=" ${requestScope.hafuGoodComment.icon}" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="images/right.jpg">
							   <div class="thumb-image"> <img src="images/right.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li> 
						</ul>
					</div>
				</div>	
				<div class="col-md-4 single-grid simpleCart_shelfItem">		
					<h3>${requestScope.hafuGoodComment.goodname}</h3>
					<p>强烈推荐！</p>
					<ul class="size">
						<h3>规格</h3>
							<li><a href="#">标准</a></li>
					...
					<div class="galry">
						<div class="prices">
							<br><h5 class="item_price">¥ ${requestScope.hafuGoodComment.goodPrice}</h5>
						</div>
						<div class="rating">
							<span>☆</span>
							<span>★</span>
			...
			<div class="panel-group collpse" id="accordion" role="tablist" aria-multiselectable="true">
				<div class="panel panel-default">
					...
					<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
						...
						${requestScope.hafuGoodComment.goodProfile}
						</div>
					</div>
				</div>
