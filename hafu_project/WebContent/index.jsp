 ...
 <div class="home_grids_w3">
  <div class="home_main">
	   <div class="col-md-7 col-sm-7 col-xs-7 img1 img-grid">
		   <div class="img_text_w3ls text-center">
			   <h4><a href="Sorry.jsp"><font color="	#FFFFFF">Starbucks.</a> </h4>
				<span> </span>
		...
		<div class="col-md-5 img2 col-sm-5 col-xs-5 img-grid">
		    <div class="img_text_w3ls text-center">
				 <h4><a href="Sorry.jsp">     <font color="	#FFFFFF">McDonald's.</a> </h4>
  ...
  <div class="home_main">
	  ...
	  <div class="col-md-7 col-sm-7 col-xs-7 img4 img-grid">
		    <div class="img_text_w3ls text-center">
				<h4><a href="Sorry.jsp"><font color="	#FFFFFF">PizzaHut.</a> </h4>
				<span> </span>
				<p>pizza and more </p>
			</div>
	 </div>
   ...
   <div class="home_main">
	   <div class="col-md-7 col-sm-7 col-xs-7 img-grid  img5">
		  <div class="img_text_w3ls text-center">
				<h4><a href="Sorry.jsp"><font color="	#FFFFFF">松本家.</a> </h4>
				<span> </span>
				<p>いい料理を作る。 </p>
		  </div>
		 </div>
		<div class="col-md-5 col-sm-5 col-xs-5 img-grid img6">
		  <div class="img_text_w3ls text-center">
				<h4><a href="Sorry.jsp"><font color="	#FFFFFF">鲜芋仙.</a> </h4>
				<span> </span>
				<p>两个老大的私房的甜品</p>
		  </div>
		 </div>
